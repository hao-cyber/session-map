...
const source = resolve(root, "desktop", "macos", "SessionMapApp.swift");
const infoTemplate = resolve(root, "desktop", "macos", "Info.plist");
const iconSource = resolve(root, "web", "sessionmap-icon.svg");
