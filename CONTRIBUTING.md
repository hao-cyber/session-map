...
SESSIONMAP_DEV=1 bun src/cli.ts serve \
...
- 把 `node_modules`、构建产物、完整 QA 截图集或真实 transcript 提交到 Git。

经过筛选、用于 README 的轻量产品截图可以提交；其中不能包含真实用户名、路径、token 或 transcript 隐私。
